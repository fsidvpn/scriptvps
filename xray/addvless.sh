...
xrayvless1="vless://${uuid}@${domain}:$tls?path=/fsidvpn&security=tls&encryption=none&type=ws#${user}"
xrayvless2="vless://${uuid}@${domain}:$nontls?path=/fsidvpn&encryption=none&type=ws#${user}"
